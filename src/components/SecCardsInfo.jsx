        ...
        <div className="mx-auto max-w-7xl px-6 sm:max-w-3xl lg:max-w-7xl lg:px-8 text-center py-32">
          ...
          >
            ...
            <p className="text-base text-gray-700 md:text-lg">
              Impulsando el desarrollo industrial de México a través de la
              ingeniería.
            </p>
          </div>
            ...
            {cards.map((card) => (
              ...
              >
                ...
                <div className="absolute top-0 left-0 z-10 w-full h-full p-6 text-lg font-medium text-black hover:bg-gradient-to-r hover:from-[#0000ff8f] hover:to-[#0000ff2c] group-hover:rounded-lg hover:text-white">
                  ...
                  <h3 className="mb-4 font-barlow font-semibold text-3xl">
                    {card.titulo}
                  </h3>
                  ...
                  <button
                    ...
                    className="text-xl relative after:absolute after:bg-gray-200 after:bottom-0 after:left-0 after:h-[2px] after:w-full after:origin-bottom-right after:scale-x-0 hover:after:origin-bottom-left hover:after:scale-x-100 after:transition-transform after:ease-in-out after:duration-300"
                  >
                    Leer más
                  </button>
                </div>
