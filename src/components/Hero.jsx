            ...
            <div class="col-xl-7 offset-xl-2 col-lg-8 info">
              <ul>
                ...
                <li>
                  ...
                  <span>Working Hours: 8:00 AM – 7:45 PM</span>
                </li>
              </ul>
            </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                  ...
                  >
                      ...
                      <ul class="dropdown-menu">
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li>
                              <a href="index-5.html">
                                SaaS Landing <span class="badge">New</span>
                              </a>
                            </li>
                            <li>
                              <a href="index-3.html">It Agency</a>
                            </li>
                            <li>
                              <a href="index-6.html">
                                Data Analysis <span class="badge">New</span>
                              </a>
                            </li>
                            <li>
                              <a href="index-7.html">
                            ...
                            <li>
                              <a href="index-4.html">Tech Solution</a>
                            </li>
                          </ul>
                        </li>
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li>
                              <a href="index-op.html">It Solutions</a>
                            </li>
                            <li>
                              <a href="index-op-2.html">Technology</a>
                            </li>
                            <li>
                              <a href="index-op-5.html">
                                SaaS Landing <span class="badge">New</span>
                              </a>
                            </li>
                            <li>
                              <a href="index-op-3.html">It Agency</a>
                            </li>
                            <li>
                              <a href="index-op-6.html">
                                Data Analysis <span class="badge">New</span>
                              </a>
                            </li>
                            <li>
                              <a href="index-op-7.html">
                                Consulting Business{" "}
                                <span class="badge">New</span>
                              </a>
                            </li>
                            <li>
                              <a href="index-op-4.html">Tech Solution</a>
                            </li>
                          </ul>
                        </li>
                      </ul>
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li>
                              <a href="about-us.html">About Style One</a>
                            </li>
                            <li>
                              <a href="about-us-2.html">About Style Two</a>
                            </li>
                            <li>
                              <a href="about-us-3.html">About Style Three</a>
                            </li>
                          </ul>
                        </li>
                        <li>
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li>
                          <a href="project-2-colum.html">Projects two colum</a>
                        </li>
                        <li>
                          <a href="project.html">Projects three colum</a>
                        </li>
                        <li>
                          <a href="project-4-colum.html">Projects four colum</a>
                        </li>
                        <li>
